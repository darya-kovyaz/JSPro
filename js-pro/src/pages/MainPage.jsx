...
import { getSections_EP, getAllTasks_EP } from "../api/api";
        ...
        return (
            <div className="mt-28 flex flex-col items-center justify-center" style={{ height: "calc(100% - 245.6px)" }}>
                {currentSectionTasks ? (
                    ...
                    <div className="mt-14 flex items-center justify-center" style={{ height: "calc(100% - 245.6px)" }}>
